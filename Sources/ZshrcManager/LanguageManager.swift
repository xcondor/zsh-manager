...
class LanguageManager: ObservableObject {
    ...
    private static let translations: [String: [Language: String]] = [
        ...
        "Environments": [.en: "Environments", .zh: "环境探测 (Dev Tools)"],
        ...
        "One-click install development environments": [.en: "One-click install development environments", .zh: "扫描并配置开发环境"],
        ...
        "Empty_Diag_Desc": [.en: "Your base configuration files have been deeply analyzed, and no significant performance issues or configuration conflicts were found.", .zh: "您的基础配置文件经过深度分析，暂未发现明显的性能隐患或配置冲突。"],
        ...
        "Detailed Report": [.en: "Detailed Report", .zh: "详细报告中心"],
        ...
        // Detection
        "Preset Desc": [.en: "One-click tool configuration", .zh: "自动环境探测与配置"],
        ...
        "Usage": [.en: "Usage Guide", .zh: "使用说明"],
        "How to use": [.en: "How to use this tool", .zh: "如何使用此工具"],
        "Copy Usage": [.en: "Copy Usage", .zh: "复制指令"],
        "Try it!": [.en: "Try it!", .zh: "点我也能试试"],
        "Example Command": [.en: "Example Command", .zh: "测试命令"],
        "Installing_Plugin_Prefix": [.en: "Installing Tool: ", .zh: "正在为您极速安装工具: "],
        "Installation_Success_Wait": [.en: "Success! Injecting config...", .zh: "安装成功！正在为您自动注入配置..."],
        "See_Details_In_Console": [.en: "Check progress in console below", .zh: "详细进度请查看下方控制台模块"],
        ...
        // Terminal Master
        "Terminal Master": [.en: "Terminal Master", .zh: "终端大师"],
        "Beautify Your Shell": [.en: "Ultimate Terminal Beautification", .zh: "一键终极美化"],
        "Boost Start": [.en: "One-Click Boost", .zh: "一键起飞"],
        "Before": [.en: "Before", .zh: "美化前"],
        "After": [.en: "After", .zh: "美化后"],
        "Component Status": [.en: "Component Status", .zh: "核心组件状态"],
        "iTerm2 App": [.en: "iTerm2 Application", .zh: "iTerm2 终端软件"],
        "Shell Theme": [.en: "P10k Visual Theme", .zh: "P10k 顶级皮肤"],
        "Nerd Font": [.en: "Nerd Symbols Font", .zh: "Nerd 图标字体"],
        "Fastest Setup": [.en: "Get a pro-grade terminal in 1 minute", .zh: "1 分钟获得专业级开发终端环境"],
        "Post-Install Tips": [.en: "Next Steps", .zh: "安装后必做"],
        "Set Font Guide": [.en: "Open iTerm2 Prefs -> Profiles -> Text -> Set Font to 'MesloLGS NF'", .zh: "在 iTerm2 设置 -> Profiles -> Text -> Font 选择 'MesloLGS NF'"],
        "Installation Log": [.en: "Installation Log", .zh: "安装日志"],
        "Please wait while we set up your terminal": [.en: "Please wait while we set up your terminal", .zh: "正在为您一键部署，请稍候..."],
        "Component Ready": [.en: "Component Ready", .zh: "组件已就绪"],
        "Interactive Enhancements": [.en: "Interactive Enhancements", .zh: "交互体验增强 (插件)"],
        "Modern Productivity Tools": [.en: "Modern Productivity Tools", .zh: "现代生产力工具 (CLI)"],
        "Core Components": [.en: "Core Components", .zh: "核心基座组件"],
        "Optimizing...": [.en: "Optimizing...", .zh: "正在极速美化..."],
        "Restore Default Theme": [.en: "Restore Default Theme", .zh: "还原默认主题配置"],
        "Success!": [.en: "Success!", .zh: "优化成功！"],
        "Done": [.en: "Done", .zh: "任务已完成"],
        "Terminal is now fully optimized.": [.en: "Terminal is now fully optimized.", .zh: "您的终端环境已达到专业级最优状态。"],
        "Process completed with some steps skipped.": [.en: "Process completed with some steps skipped.", .zh: "优化流程已完成（部分已配置项已跳过）。"],
        
        // Plugin Descriptions
        "基于历史记录的实时补全建议": [.en: "Real-time completion suggestions based on history", .zh: "基于历史记录的实时补全建议"],
        "终端命令实时合法性高亮 (绿色/红色)": [.en: "Real-time command validity highlighting (Green/Red)", .zh: "终端命令实时合法性高亮 (绿色/红色)"],
        "神奇的命令纠错工具，如果你敲错了，输入 fuck 自动修复": [.en: "Magical command correction tool, type fuck to fix your typo", .zh: "神奇的命令纠错工具，如果你敲错了，输入 fuck 自动修复"],
        "更高级的 cd 方式，智能跳转到你常用的目录": [.en: "Advanced cd tool that jumps to your frequent directories", .zh: "更高级的 cd 方式，智能跳转到你常用的目录"],
        "最实用的命令说明书，直接给你看案例而不是冗长的文档": [.en: "Practical cheat sheet for commands with real examples", .zh: "最实用的命令说明书，直接给你看案例而不是冗长的文档"],
        "万用解压工具，无论是 zip, tar 还是 gz，一键解压": [.en: "Universal extraction tool for zip, tar, gz, etc.", .zh: "万用解压工具，无论是 zip, tar 还是 gz，一键解压"],
        "快速补齐 sudo，双击 ESC 即可让上条命令获得管理员权限": [.en: "Quickly add sudo by double-tapping ESC", .zh: "快速补齐 sudo，双击 ESC 即可让上条命令获得管理员权限"],
        "现代版 ls，带图标、色彩和更好的格式展示": [.en: "Modern ls replacement with icons and better formatting", .zh: "现代版 ls，带图标、色彩和更好的格式展示"],
        "现代版 cat，带语法高亮、行号和 Git 状态集成": [.en: "Modern cat replacement with syntax highlighting and Git integration", .zh: "现代版 cat，带语法高亮、行号和 Git 状态集成"],
        "将 Tab 补全菜单替换为强大的模糊搜索界面": [.en: "Replace Tab completion menu with a powerful fuzzy finder", .zh: "将 Tab 补全菜单替换为强大的模糊搜索界面"],
        "Top-tier plugins for better typing experience": [.en: "Top-tier plugins for better typing experience", .zh: "全球最顶尖的 Zsh 增强插件，大幅提升敲击体验"],
        "Reinventing classic commands with modern superpowers": [.en: "Reinventing classic commands with modern superpowers", .zh: "使用现代化的工具替代那些古老的传统命令"],
        ...
        "Pyenv Not Installed": [.en: "Python Manager not found", .zh: "还未找到 Python 管理核心 (Pyenv)"],
        "Please install Pyenv in 'Essential Services' first.": [.en: "Please install Pyenv to manage multiple Python versions safely.", .zh: "安装 Pyenv 后即可全自动管理多版本 Python，互不冲突。"],
        "Install Pyenv Now": [.en: "One-click Install Pyenv", .zh: "一键安装管理核心 (Pyenv)"],
        "System Python Found": [.en: "System Python Found", .zh: "检测到系统自带 Python"],
        "Recommended for Developers": [.en: "Recommended for Developers", .zh: "全自动托管 (推荐)"],
        ...
        "Development tool detection": [.en: "Development tool detection", .zh: "全环境扫描检测与探测配置"],
        ...
        "Quickly help users configure a specific environment": [.en: "Quickly help users configure a specific environment", .zh: "自动扫描本地工具，点此完成环境绑定"],
        ...
        "Security": [.en: "Security", .zh: "安全防护"],
        "Performance": [.en: "Performance", .zh: "运行性能"],
        "Stability": [.en: "Stability", .zh: "核心稳定性"],
        "Startup Time": [.en: "Startup Time", .zh: "启动耗时"],
        "Privacy Risk Found": [.en: "Privacy Risk Found", .zh: "发现隐私泄露风险"],
        "Detected Secrets": [.en: "Sensitive strings detected in plain text", .zh: "检测到明文存储的密钥信息"],
        "Migrate to Keychain": [.en: "Move to Keychain (Recommended)", .zh: "迁移至系统钥匙串 (推荐)"],
        "Optimization Guide": [.en: "Optimization Guide", .zh: "极速优化建议"],
        "Slow Command Found": [.en: "Slow command found", .zh: "检测到慢速启动指令"],
        "Cloud Sync Status": [.en: "Cloud Sync Status", .zh: "多机同步状态"],
        "Sync Paused": [.en: "Sync Paused", .zh: "同步已暂停"],
        "Pro Feature": [.en: "Pro Feature", .zh: "专业版特权"],
        "Unlock Pro": [.en: "Unlock Pro Experience", .zh: "解锁专业版体验"],
        "Review Report": [.en: "Review Full Report", .zh: "查看完整报告"],
        "Intent Analysis": [.en: "Intent Analysis", .zh: "智能意图分析"],
        "No significant changes.": [.en: "No significant changes.", .zh: "没有检测到显着改动。"],
        "Defining_Aliases": [.en: "Defining new terminal shortcut(s)", .zh: "正在定义新的终端快捷指令 (Alias)"],
        "Modifying_Path": [.en: "Modifying system executable search paths", .zh: "正在修改系统可执行文件搜索路径 (PATH)"],
        "Adding_Secrets": [.en: "Adding sensitive environment variables (Secrets)", .zh: "正在添加敏感环境变量 (Secrets)"],
        "General_Adjustment": [.en: "General configuration adjustment", .zh: "一般配置调整"],
        "Support & Questions": [.en: "Support & Questions", .zh: "问题反馈与建议"],
        "Send Feedback": [.en: "Send Feedback", .zh: "发送留言"],
        "Feedback_Email_Subject": [.en: "Feedback for Zshrc Manager", .zh: "Zshrc Manager 问题反馈"],
        "Trial Status": [.en: "Trial Status", .zh: "全功能试用状态"],
        "Days Remaining": [.en: "days remaining", .zh: "天试用期剩余"],
        "Trial Expired": [.en: "Trial Expired", .zh: "试用期已结束"],
        "Unlock Pro Features": [.en: "Upgrade to Pro", .zh: "极速升级 Pro"],
        "Pro Activated": [.en: "Pro Activated", .zh: "已解锁专业版"],
        "Enter License Key": [.en: "Enter License Key", .zh: "输入授权密钥"],
        "Activate": [.en: "Activate", .zh: "立即激活"],
        "Purchase License": [.en: "Buy License", .zh: "官网购买授权码"],
        "iCloud Sync": [.en: "iCloud Sync", .zh: "iCloud 同步"],
        "Sync configurations across all your Macs": [.en: "Sync configurations across all your Macs", .zh: "在您的所有 Mac 之间同步配置"],
        "iCloud Backup": [.en: "iCloud Backup", .zh: "iCloud 备份"],
        "Sync aliases.json to iCloud Drive": [.en: "Sync aliases.json to iCloud Drive", .zh: "将 aliases.json 同步到 iCloud Drive"],
        "Last Synced": [.en: "Last Synced", .zh: "上次同步"],
        "Never": [.en: "Never", .zh: "从未"],
        "Up to Date": [.en: "Up to Date", .zh: "已是最新"],
        "Syncing...": [.en: "Syncing...", .zh: "同步中..."],
        "Sync Failed": [.en: "Sync Failed", .zh: "同步失败"],
        "CloudSync_Privacy_Notice": [.en: "Your configuration is stored in your own iCloud Drive account. Zshrc Manager does not access your private data, and all settings are transferred directly between your devices only.", .zh: "您的配置存储在您自己的 iCloud Drive 账户中。Zshrc Manager 不会访问您的个人数据，所有设置仅在您的设备之间直接传输。"]
    ]
