...
struct SnapshotView: View {
    ...
    var body: some View {
        ProGateView(title: lang.t("Snapshots")) {
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    VStack(alignment: .leading, spacing: 20) {
                        HStack {
                            ...
                            Spacer()
                            GlowButton(label: lang.t("Take Snapshot"), icon: "camera.viewfinder", color: .green) {
        ...
        .sheet(isPresented: $showingAddPopover) {
            VStack(spacing: 20) {
                HeroBanner(title: lang.t("New Snapshot"), subtitle: "Save current state", icon: "camera.shutter.button.fill", color: .green)
                ...
                HStack {
                    ...
                    Spacer()
                    GlowButton(label: lang.t("Save Snapshot"), icon: "checkmark.circle.fill", color: .green) {
